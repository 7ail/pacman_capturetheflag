...
class DummyAgent(CaptureAgent):
  ...
  def chooseAction(self, gameState):
    ...
    '''
    #AStar search to find path to food
    #inference to chase pacman
    #inference to avoid ghosts
    #utility function to choose action
  ...
  def isGoalState(index):
    if self.red:
      return self.getRedFood()[index[0]][index[1]]
    else:
      return self.getBlueFood()[index[0]][index[1]]

  #I can redefine methods in the Problem class - more overhead but more object oriented code
  #I can eliminate the problem class and define helper functions
